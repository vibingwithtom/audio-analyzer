 ...
 * - 'fast': Samples every 10th sample (90% faster, <0.1dB typical error)
 */
...
export interface AppSettings {
  ...
  peakDetectionMode?: PeakDetectionMode; // Peak detection: 'accurate' (every sample) or 'fast' (every 10th sample, 90% faster)
}
